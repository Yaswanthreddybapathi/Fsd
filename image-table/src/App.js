...
const ImageTable =({ selectedImages }) => {
  return (
    <div className="table-container">
      ...
      <thead>
        <tr>
     <th style={{ border: '1px solid #3824ee',padding: '8px',textAlign: 'center',
                               backgroundColor: 'lightblue' }}>Image</th>
     <th style={{ border: '1px solid #3824ee',padding: '8px',textAlign: 'center',
                               backgroundColor: 'lightblue' }}>Name</th>
    </tr>
...
const App = () => {
  ...
  return (
    <div>
      ...
      <div className="watermark">yaswanth</div>
    </div>
  );
};
